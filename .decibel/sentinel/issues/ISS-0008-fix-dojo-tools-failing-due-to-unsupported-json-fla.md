---
uid: 019b1fad-f55b-72e4-9980-579f550253d5
id: ISS-0008
...
updated_at: 2026-08-29T16:18:24.778Z
closed_at: 2026-08-29T16:18:24.778Z
resolution: Already fixed. dojo.ts uses native file operations (fs/promises + YAML) not CLI. Verified zero references to spawn/execSync/child_process. The --flag handling concern is moot since no CLI is invoked.
---
# Fix Dojo tools failing due to unsupported --json flag in decibel CLI
...
Already fixed. dojo.ts uses native file operations (fs/promises + YAML) not CLI. Verified zero references to spawn/execSync/child_process. The --flag handling concern is moot since no CLI is invoked.
