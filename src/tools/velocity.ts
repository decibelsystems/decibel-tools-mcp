...
# Installed by: @decibelsystems/tools velocity_install_hook
...
export async function installHook(
  ...
  // Find the @decibelsystems/tools installation path (for the hook to import from)
  // Use a relative approach - the hook will use the project's node_modules or global
  const decibelPath = '@decibelsystems/tools';
